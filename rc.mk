...
CFLAGS=-I/usr/local/include -I/opt/local/include $(SDL_CFLAGS) -fsigned-char -D_REENTRANT -DUSE_MEMORY_H -std=c99 -DSDLFE_NO_HWACCEL=1
...
DISTFILES=$(COMMON_DISTBIN_FILES) gmuinput.rc.conf gmu.sh
